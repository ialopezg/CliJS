...
describe('ConsoleColorService', () => {
  it('should print a console text with black background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BLACK)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright black background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BRIGHT_BLACK)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with red background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_RED)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright red background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BRIGHT_RED)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with green background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_GREEN)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright green background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BRIGHT_GREEN)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with yellow background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_YELLOW)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright yellow background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BRIGHT_YELLOW)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with blue background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BLUE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright blue background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BRIGHT_BLUE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with magenta background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_MAGENTA)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright magenta background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BRIGHT_MAGENTA)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with cyan background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_CYAN)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright cyan background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BRIGHT_CYAN)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with white background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_WHITE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright white background color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.BG_BRIGHT_WHITE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with black color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BLACK)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright black color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BRIGHT_BLACK)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with red color', () => {
    const color = ccs.red;
    const greetingText = `${ccs.getColor(Color.FG_RED)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright red color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BRIGHT_RED)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with green color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_GREEN)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright green color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BRIGHT_GREEN)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with yellow color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_YELLOW)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright yellow color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BRIGHT_YELLOW)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with blue color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BLUE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright blue color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BRIGHT_BLUE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with magenta color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_MAGENTA)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright magenta color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BRIGHT_MAGENTA)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with cyan color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_CYAN)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright cyan color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BRIGHT_CYAN)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with white color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_WHITE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a console text with bright white color', () => {
    ...
    const greetingText = `${ccs.getColor(Color.FG_BRIGHT_WHITE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a bold console text', () => {
    ...
    const greetingText = `${ccs.getTransformation(Transformation.BOLD)}Hello World!${ccs.reset()}`;
  ...
  it('should print an italic console text', () => {
    ...
    const greetingText = `${ccs.getTransformation(Transformation.ITALIC)}Hello World!${ccs.reset()}`;
  ...
  it('should print a dimmed console text', () => {
    const color = ccs.dim;
    const greetingText = `${ccs.getTransformation(Transformation.DIM)}Hello World!${ccs.reset()}`;
  ...
  it('should print an underlined console text', () => {
    ...
    const greetingText = `${ccs.getTransformation(Transformation.UNDERLINE)}Hello World!${ccs.reset()}`;
  ...
  it('should print an inversed console text', () => {
    ...
    const greetingText = `${ccs.getTransformation(Transformation.INVERSE)}Hello World!${ccs.reset()}`;
  ...
  it('should print a strikedthrough console text', () => {
    ...
    const greetingText = `${ccs.getTransformation(Transformation.STRIKETHROUGH)}Hello World!${ccs.reset()}`;
  ...
  it('should print a hidden console text', () => {
    ...
    const greetingText = `${ccs.getTransformation(Transformation.HIDDEN)}Hello World!${ccs.reset()}`;
